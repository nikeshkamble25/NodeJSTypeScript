...
var AuthHandler = /** @class */ (function () {
    function AuthHandler() {
        ...
        this.handleResponse = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                res.redirect('/currentuser');
                return [2 /*return*/];
            });
        }); };
        this.handleCurrentUser = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                res.send(req.user);
                return [2 /*return*/];
            });
        }); };
        this.handleLogout = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                req.logout();
                res.send(req.user);
                return [2 /*return*/];
